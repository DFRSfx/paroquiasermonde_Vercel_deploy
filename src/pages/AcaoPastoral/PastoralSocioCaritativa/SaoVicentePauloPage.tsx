...
const SaoVicentePauloPage: React.FC = () => {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          <p className="text-sm text-gray-300 mb-4">
            ...
            <span className="mx-2 opacity-50">/</span>
            <span>Pastoral Sócio-Caritativa</span>
            <span className="mx-2 opacity-50">/</span>
            <span className="text-white">Conferência S. Vicente de Paulo</span>
          </p>
...
export default SaoVicentePauloPage;
