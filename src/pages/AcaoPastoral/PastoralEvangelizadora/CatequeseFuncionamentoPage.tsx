...
const CatequeseFuncionamentoPage: React.FC = () => {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          <p className="text-sm text-gray-300 mb-4">
            ...
            <a href="/pastoral/catequese" className="hover:text-white transition-colors">Catequese</a>
            <span className="mx-2 opacity-50">/</span>
...
export default CatequeseFuncionamentoPage;
