...
const ApostoladoOracaoFuncionamentoPage: React.FC = () => {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          <p className="text-sm text-gray-300 mb-4">
            ...
            <a href="/pastoral/apostolado-oracao" className="hover:text-white transition-colors">Apostolado da Oração</a>
            <span className="mx-2 opacity-50">/</span>
            <span className="text-white">Funcionamento e Informações Úteis</span>
          </p>
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-serif font-bold tracking-tight">
            Funcionamento e Informações Úteis
          </h1>
        </div>
      </section>
...
export default ApostoladoOracaoFuncionamentoPage;
