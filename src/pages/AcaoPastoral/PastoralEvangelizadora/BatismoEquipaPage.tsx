...
const BatismoEquipaPage: React.FC = () => {
  return (
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          <p className="text-sm text-gray-300 mb-4">
            ...
            <a href="/sacramentos/batismo" className="hover:text-white transition-colors">Batismo</a>
            <span className="mx-2 opacity-50">/</span>
            <span className="text-white">Equipa e Funcionamento</span>
          </p>
...
export default BatismoEquipaPage;
